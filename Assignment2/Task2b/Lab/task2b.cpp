...
int main(void)
{
	...
	std::vector<cl_char> charVec(2754), charVecEncryptOutput(2754), charVecDecryptOutput(2754);
	cl::Buffer encryptInputBuffer, encryptOutputBuffer, decryptInputBuffer, decryptOutputBuffer;
